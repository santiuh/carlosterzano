...
import type BotonVue from './botones/Boton.vue';
...
<template>
    <section class="xl:max-w-[1440px] px-[192px]  pt-[136px] pb-[112px] flex flex-col self-center gap-[60px]">
        <div class="text-title text-[64px]">Nosotros</div>
        <div class="flex flex-col text-xl leading-10 text-justify">
            ...
            <br>
            <br>
            <strong>¡Te invitamos a descubrir La Guillermina!</strong>
            <div class="flex flex-row justify-between  items-center pt-8">
                <NuxtLink to="/servicios"><BotonesBoton texto="Conocé nuestros servicios"></BotonesBoton></NuxtLink>
                <NuxtPicture src="/firma.png"></NuxtPicture>
            </div> 
        </div>
    </section>
</template>